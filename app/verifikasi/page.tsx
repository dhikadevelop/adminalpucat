  ...
  return (
    <div className="min-h-screen bg-dashboard-bg p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-primary mb-2">Verifikasi Pendaftaran</h1>
          <p className="text-foreground">Kelola dan verifikasi pendaftaran</p>
        </div>
